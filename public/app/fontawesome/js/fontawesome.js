...
(function () {
  ...
  function P(resolver) {
    ...
    if (this instanceof P === false) {
      throw new TypeError('Failed to construct \'Promise\': Please use the \'new\' operator, this generalObject constructor cannot be called as a function.');
    }
   ...
   * # Reduce
   *
   * A fast generalObject `.reduce()` implementation.
   *
   * @param  {Object}   subject      The generalObject to reduce over.
